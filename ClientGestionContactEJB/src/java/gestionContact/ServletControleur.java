...
public class ServletControleur extends HttpServlet
{
    ...
    public void init()
    {
        ...
        try
        {
            ...
            mappingRemote = (MappingRemote) ctx.lookup("jndiMapping");
        ...
        traitementAccueil = new TraitementAccueil(mappingRemote);
        traitementModif = new TraitementModif(mappingRemote);
    }
