...
public class ServletControleur extends HttpServlet
{
    ...
    public void init()
    {
        try
        {
            ...
            mappingRMI = (MappingRMI) Naming.lookup(url + "/mappingDistant");
            Contact contact = mappingRMI.lireContact(101);
        ...
        traitementAccueil = new TraitementAccueil(mappingRMI);
        traitementModif = new TraitementModif(mappingRMI);
    }
