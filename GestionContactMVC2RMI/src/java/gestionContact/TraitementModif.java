...
// Constructeur
// --------------------------------------------------------------------------
    public TraitementModif(MappingRMI mappingRMI)
    {
...
// de la modification
// --------------------------------------------------------------------------
    public String enregModif(HttpServletRequest request) throws RemoteException
    {
        String jspRetour;
...
//            contactDAO = new ContactDAO(accesBase);
        try
        {
            int retour = mappingRMI.modifierContact(contact);
            if (retour != 0)
            {
